...
The Related Encounters tab displays 2 sub grids, 1 for recurring encounters and 1 for single encounters. [Learn more about Encounters](SingleEncounters).
...
3. Go to the Encounter Services tab. Filter to the date of sessions that should be scheduled against the new care team assignment.
