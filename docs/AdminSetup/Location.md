...
- *Location Name* - This field is defaulted to match location type, but can be edited in the scenario where a more specific name should show on session notes (e.g., "Community" instead of "Other", or "Provider Home Office" instead of "Home").
