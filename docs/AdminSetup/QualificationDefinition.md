...
- *Show on Session Notes* - choose whether this is a qualification that should be mentioned next to a practitioner's signature in [session note exports](../Billing/Export%20Session%20Notes.md) for sessions rendered by this practitioner. 
